 ...
 */
C4G_RUNTIME_API void c4grt_set_pass_pipe(struct C4GRT_Runtime* rt, C4GRT_PassId pass, C4GRT_Bool pipe);
 ...
 */
C4G_RUNTIME_API void c4grt_use_gpu_program_file(struct C4GRT_Runtime* rt, C4GRT_PassId pass, const char* const f, const char* varyings[], size_t vs);
/**
 ...
 * @param[in] vs - Count of varying names.
 */
C4G_RUNTIME_API void c4grt_use_gpu_program_string(struct C4GRT_Runtime* rt, C4GRT_PassId pass, const char* const c, const char* varyings[], size_t vs);
